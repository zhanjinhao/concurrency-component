package cn.addenda.component.concurrency.util;
...
public class CompletableFutureUtils {
  ...
  public static <T> CompletableFuture<T> orTimeout(CompletableFuture<T> future, Duration duration) {
    return orTimeout(future, duration.toMillis(), TimeUnit.MILLISECONDS);
  }
  ...
  public static <T> CompletableFuture<T> orTimeout(CompletableFuture<T> future, T value, Duration duration) {
    return completeOnTimeout(future, value, duration.toMillis(), TimeUnit.MILLISECONDS);
  }
